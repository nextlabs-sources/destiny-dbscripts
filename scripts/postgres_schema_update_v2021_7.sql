INSERT INTO SYS_CONFIG (ID, APPLICATION, CONFIG_KEY, VALUE, DEFAULT_VALUE, VALUE_FORMAT, MAIN_GROUP, SUB_GROUP, MAIN_GROUP_ORDER, SUB_GROUP_ORDER, CONFIG_ORDER, HIDDEN, READ_ONLY, ADVANCED, UI, ENCRYPTED, RESTART_REQUIRED, DATA_TYPE, FIELD_TYPE, OPTIONS, REQUIRED, PATTERN, DESCRIPTION, MODIFIED_ON, MODIFIED_BY ) VALUES (NEXTVAL('HIBERNATE_SEQUENCE'), 'console', 'policyValidator.url', 'https://${server.hostname}:6443/policy-validator', 'https://${server.hostname}:6443/policy-validator', '', 'general', 'url', '0', '10', '10', '0', '0', '1', '0', '0', '1', 'text', 'text', '', '1', '', 'Control Center Policy Validator URL.', CURRENT_TIMESTAMP, '-1' )
ON CONFLICT (APPLICATION, CONFIG_KEY) DO UPDATE SET VALUE = 'https://${server.hostname}:6443/policy-validator', DEFAULT_VALUE = 'https://${server.hostname}:6443/policy-validator', VALUE_FORMAT = '', MAIN_GROUP = 'general', SUB_GROUP = 'url', MAIN_GROUP_ORDER = '0', SUB_GROUP_ORDER = '10', CONFIG_ORDER = '10', HIDDEN = '0', READ_ONLY = '0', ADVANCED = '1', UI = '0', ENCRYPTED = '0', RESTART_REQUIRED = '1', DATA_TYPE = 'text', FIELD_TYPE = 'text' , OPTIONS = '', REQUIRED = '1', PATTERN = '', DESCRIPTION = 'Control Center Policy Validator URL.', MODIFIED_ON = CURRENT_TIMESTAMP, MODIFIED_BY = '-1';

INSERT INTO ACCESS_CONTROL (ID, REQUEST_METHOD, URL_PATTERN, EXPRESSION) VALUES (NEXTVAL('HIBERNATE_SEQUENCE'), 'GET', '/policy-validator', 'authenticated');
...
INSERT INTO SYS_CONFIG (ID, APPLICATION, CONFIG_KEY, VALUE, DEFAULT_VALUE, VALUE_FORMAT, MAIN_GROUP, SUB_GROUP, MAIN_GROUP_ORDER, SUB_GROUP_ORDER, CONFIG_ORDER, HIDDEN, READ_ONLY, ADVANCED, UI, ENCRYPTED, RESTART_REQUIRED, DATA_TYPE, FIELD_TYPE, OPTIONS, REQUIRED, PATTERN, DESCRIPTION, MODIFIED_ON, MODIFIED_BY ) VALUES (NEXTVAL('HIBERNATE_SEQUENCE'), 'console', 'data.transportation.keyStoreFile', '${cc.home}/server/certificates/digital-signature-keystore.p12', '${cc.home}/server/certificates/digital-signature-keystore.p12', '', 'policy', 'data.transportation', '10', '0', '6', '1', '1', '0', '0', '0', '1', 'text', 'text', '', '0', '', '', CURRENT_TIMESTAMP, '-1' )
ON CONFLICT (APPLICATION, CONFIG_KEY) DO UPDATE SET VALUE = '${cc.home}/server/certificates/digital-signature-keystore.p12', DEFAULT_VALUE = '${cc.home}/server/certificates/digital-signature-keystore.p12', VALUE_FORMAT = '', MAIN_GROUP = 'policy', SUB_GROUP = 'data.transportation', MAIN_GROUP_ORDER = '10', SUB_GROUP_ORDER = '0', CONFIG_ORDER = '6', HIDDEN = '1', READ_ONLY = '1', ADVANCED = '0', UI = '0', ENCRYPTED = '0', RESTART_REQUIRED = '1', DATA_TYPE = 'text', FIELD_TYPE = 'text' , OPTIONS = '', REQUIRED = '0', PATTERN = '', DESCRIPTION = '', MODIFIED_ON = CURRENT_TIMESTAMP, MODIFIED_BY = '-1';

INSERT INTO SYS_CONFIG (ID, APPLICATION, CONFIG_KEY, VALUE, DEFAULT_VALUE, VALUE_FORMAT, MAIN_GROUP, SUB_GROUP, MAIN_GROUP_ORDER, SUB_GROUP_ORDER, CONFIG_ORDER, HIDDEN, READ_ONLY, ADVANCED, UI, ENCRYPTED, RESTART_REQUIRED, DATA_TYPE, FIELD_TYPE, OPTIONS, REQUIRED, PATTERN, DESCRIPTION, MODIFIED_ON, MODIFIED_BY ) VALUES (NEXTVAL('HIBERNATE_SEQUENCE'), 'console', 'data.transportation.trustStoreFile', '${cc.home}/server/certificates/digital-signature-truststore.p12', '${cc.home}/server/certificates/digital-signature-truststore.p12', '', 'policy', 'data.transportation', '10', '0', '7', '1', '1', '0', '0', '0', '1', 'text', 'text', '', '0', '', '', CURRENT_TIMESTAMP, '-1' )
ON CONFLICT (APPLICATION, CONFIG_KEY) DO UPDATE SET VALUE = '${cc.home}/server/certificates/digital-signature-truststore.p12', DEFAULT_VALUE = '${cc.home}/server/certificates/digital-signature-truststore.p12', VALUE_FORMAT = '', MAIN_GROUP = 'policy', SUB_GROUP = 'data.transportation', MAIN_GROUP_ORDER = '10', SUB_GROUP_ORDER = '0', CONFIG_ORDER = '7', HIDDEN = '1', READ_ONLY = '1', ADVANCED = '0', UI = '0', ENCRYPTED = '0', RESTART_REQUIRED = '1', DATA_TYPE = 'text', FIELD_TYPE = 'text' , OPTIONS = '', REQUIRED = '0', PATTERN = '', DESCRIPTION = '', MODIFIED_ON = CURRENT_TIMESTAMP, MODIFIED_BY = '-1';
