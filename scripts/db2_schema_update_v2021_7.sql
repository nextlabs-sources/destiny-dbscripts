MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'policyValidator.url')
...
WHEN NOT MATCHED THEN INSERT (ID, APPLICATION, CONFIG_KEY, VALUE, DEFAULT_VALUE, VALUE_FORMAT, MAIN_GROUP, SUB_GROUP, MAIN_GROUP_ORDER, SUB_GROUP_ORDER, CONFIG_ORDER, HIDDEN, READ_ONLY, ADVANCED, UI, ENCRYPTED, RESTART_REQUIRED, DATA_TYPE, FIELD_TYPE, OPTIONS, REQUIRED, PATTERN, DESCRIPTION, MODIFIED_ON, MODIFIED_BY ) VALUES (HIBERNATE_SEQUENCE.NEXTVAL, 'console', 'policyValidator.url', 'https://${server.hostname}:6443/policy-validator', 'https://${server.hostname}:6443/policy-validator', '', 'general', 'url', '0', '10', '10', '0', '0', '1', '0', '0', '1', 'text', 'text', '', '1', '', 'Control Center Policy Validator URL.', CURRENT_TIMESTAMP, '-1' );

INSERT INTO ACCESS_CONTROL (ID, REQUEST_METHOD, URL_PATTERN, EXPRESSION) VALUES (HIBERNATE_SEQUENCE.NEXTVAL, 'GET', '/policy-validator', 'authenticated');
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'data.transportation.keyStoreFile')
...
WHEN NOT MATCHED THEN INSERT (ID, APPLICATION, CONFIG_KEY, VALUE, DEFAULT_VALUE, VALUE_FORMAT, MAIN_GROUP, SUB_GROUP, MAIN_GROUP_ORDER, SUB_GROUP_ORDER, CONFIG_ORDER, HIDDEN, READ_ONLY, ADVANCED, UI, ENCRYPTED, RESTART_REQUIRED, DATA_TYPE, FIELD_TYPE, OPTIONS, REQUIRED, PATTERN, DESCRIPTION, MODIFIED_ON, MODIFIED_BY ) VALUES (HIBERNATE_SEQUENCE.NEXTVAL, 'console', 'data.transportation.keyStoreFile', '${cc.home}/server/certificates/digital-signature-keystore.p12', '${cc.home}/server/certificates/digital-signature-keystore.p12', '', 'policy', 'data.transportation', '10', '0', '6', '1', '1', '0', '0', '0', '1', 'text', 'text', '', '0', '', '', CURRENT_TIMESTAMP, '-1' );
...
WHEN NOT MATCHED THEN INSERT (ID, APPLICATION, CONFIG_KEY, VALUE, DEFAULT_VALUE, VALUE_FORMAT, MAIN_GROUP, SUB_GROUP, MAIN_GROUP_ORDER, SUB_GROUP_ORDER, CONFIG_ORDER, HIDDEN, READ_ONLY, ADVANCED, UI, ENCRYPTED, RESTART_REQUIRED, DATA_TYPE, FIELD_TYPE, OPTIONS, REQUIRED, PATTERN, DESCRIPTION, MODIFIED_ON, MODIFIED_BY ) VALUES (HIBERNATE_SEQUENCE.NEXTVAL, 'console', 'data.transportation.trustStoreFile', '${cc.home}/server/certificates/digital-signature-truststore.p12', '${cc.home}/server/certificates/digital-signature-truststore.p12', '', 'policy', 'data.transportation', '10', '0', '7', '1', '1', '0', '0', '0', '1', 'text', 'text', '', '0', '', '', CURRENT_TIMESTAMP, '-1' );
