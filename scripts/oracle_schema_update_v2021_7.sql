MERGE INTO SYS_CONFIG USING (SELECT 1 FROM DUAL) ON (APPLICATION = 'console' AND CONFIG_KEY = 'policyValidator.url')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM DUAL) ON (APPLICATION = 'console' AND CONFIG_KEY = 'data.transportation.keyStoreFile')
