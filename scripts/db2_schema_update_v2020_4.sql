...
ALTER TABLE ENTITY_AUDIT_LOG ALTER COLUMN ACTION SET DATA TYPE VARCHAR(30);
...
CREATE TABLE SECURE_STORE (
    ...
    STORE_FILE         BLOB(2147483647) NULL,
    HASH_ALGORITHM     VARCHAR(25 BYTE) NOT NULL,
    CHECKSUM           VARCHAR(256 BYTE) NOT NULL,
...
CREATE TABLE PROVISIONED_USER_GROUP (
    ID BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY (  
		    ...
		    CACHE 20  
		    NO ORDER ),
    AUTH_HANDLER_ID    NUMERIC NOT NULL,
    GROUP_ID           VARCHAR(255 BYTE) NOT NULL,
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'application' AND CONFIG_KEY = 'application.build')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'data.transportation.trustStoreFile')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'dashboard.widget.active-users.enabled')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'dashboard.widget.activities-by-resource.enabled')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'dashboard.widget.activity-alerts.enabled')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'dashboard.widget.enrollment.enabled')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'dashboard.widget.frequently-evaluated-policies.enabled')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'dashboard.widget.pdp-throughput.enabled')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'dashboard.widget.policies-grouped-by-tags.enabled')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'dashboard.widget.policies-not-matched-in-any-request.enabled')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'dashboard.widget.recent-activities.enabled')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'dashboard.widget.system-configuration-status.enabled')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'dashboard.widget.system-details.enabled')
...
MERGE INTO SYS_CONFIG USING (SELECT 1 FROM SYSIBM.SYSDUMMY1) ON (APPLICATION = 'console' AND CONFIG_KEY = 'db.comboPooledDataSource.maxIdleTimeExcessConnections')
