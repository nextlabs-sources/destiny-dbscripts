...
INSERT INTO ACCESS_CONTROL (ID, REQUEST_METHOD, URL_PATTERN, EXPRESSION) VALUES (NEXTVAL('HIBERNATE_SEQUENCE'), 'POST', '/api/v1/secureStore/importPemKeyPair', 'hasAuthority(''MANAGE_SECURE_STORE'')');
