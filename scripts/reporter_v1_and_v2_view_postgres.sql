...
CREATE OR REPLACE VIEW policy_log_v1 AS
  SELECT 
    id as id,
    time as timestamp,
    month_nb as month,
...
CREATE OR REPLACE VIEW policy_custom_attribute_v1 AS
...
CREATE OR REPLACE VIEW policy_obligation_log_v1 AS
  SELECT 
    id as id,
...
CREATE OR REPLACE VIEW tracking_log_v1 AS
  SELECT 
    id as id,
    time as timestamp,
    month_nb as month,
...
CREATE OR REPLACE VIEW tracking_custom_attribute_v1 AS
  SELECT 
    id as id,
...
CREATE OR REPLACE VIEW policy_log_v2 AS
  SELECT 
    id as id,
    time as timestamp,
    month_nb as month,
...
CREATE OR REPLACE VIEW policy_custom_attribute_v2 AS
  SELECT 
...
CREATE OR REPLACE VIEW policy_attr_mapping_v2 AS 
  SELECT 
